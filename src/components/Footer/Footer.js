      ...
      <div className='footer__container-first'>
        <div className="footer__contacts">
          ...
          <ul className="footer__contacts-list list">
            <li className="footer__contacts-item"><a className="footer__contacts-link link" href="https://thecode.media/" target="_blank" rel="noreferrer">Журнал</a></li>
          </ul>
        </div>
        <ul className='footer__nav list'>
          ...
          <li className='footer__nav-link'><a className='link' href="https://practicum.yandex.ru/job" target="_blank" rel="noreferrer">Вакансии</a></li>
