    ...
    <footer className="footer">
      ...
      <div className='footer__container-first'>
        ...
        <ul className='footer__nav'>
          ...
          <li className='footer__nav-link'><a href="https://practicum.yandex.ru/job" target="_blank">Вакансии</a></li>
          <li className='footer__nav-link'><a href="https://practicum.yandex.ru/employment/" target="_blank">Для работодателей</a></li>
          <li className='footer__nav-link'><a href="https://practicum.yandex.ru/reviews" target="_blank">Отзывы</a></li>
          <li className='footer__nav-link'><a href="https://yandex.ru/legal/practicum_termsofuse/" target="_blank">Правовая информация</a></li>
          <li className='footer__nav-link'><a href="https://code.s3.yandex.net/License%20YSDA.pdf" target="_blank">Лицензия</a></li>
        </ul>
      </div>
